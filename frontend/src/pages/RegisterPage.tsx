    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Join the elite community of chess players.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-chess-green transition-colors" size={20} />
              <input 
                type="email" 
                required
                value={email}
        ...
        <p className="mt-8 text-center text-gray-400">
          Already have an account? <Link to="/login" className="text-chess-green font-bold hover:underline">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
